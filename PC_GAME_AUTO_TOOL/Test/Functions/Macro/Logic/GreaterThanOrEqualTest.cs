...
namespace Test.Functions.Macro.Logic
{
    ...
    public class GreaterThanOrEqualTest
    {
        ...
        public void testGreaterThanOrEqual()
        {
            // trueとなることを確認する
            {
                PC_GAME_AUTO_TOOL.Functions.Macro.Logic.InterFace.Logic command = new GreaterThanOrEqual("-1", "-2");
                Assert.IsTrue(command.execute());
            }

            // trueとなることを確認する
            {
                PC_GAME_AUTO_TOOL.Functions.Macro.Logic.InterFace.Logic command = new GreaterThanOrEqual("0", "-1");
                Assert.IsTrue(command.execute());
            }

            // trueとなることを確認する
            {
                PC_GAME_AUTO_TOOL.Functions.Macro.Logic.InterFace.Logic command = new GreaterThanOrEqual("1", "0");
                Assert.IsTrue(command.execute());
            }
        ...
        public void testGreaterThanOrEqualNoArgs()
        {
            ...
            {
                PC_GAME_AUTO_TOOL.Functions.Macro.Logic.InterFace.Logic command = new GreaterThanOrEqual();
            });
        }
        ...
        public void testGreaterThanOrEqual3Args()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() =>
            {
                PC_GAME_AUTO_TOOL.Functions.Macro.Logic.InterFace.Logic command = new GreaterThanOrEqual("1", "2", "3");
            });
        }
        ...
        public void testGreaterThanOrEqualWrongArgs()
        {
            ...
            Assert.ThrowsException<ArgumentException>(() =>
            {
                PC_GAME_AUTO_TOOL.Functions.Macro.Logic.InterFace.Logic command = new GreaterThanOrEqual("a", "2");
            });

            // コンストラクタで例外がスローされることを確認する
            Assert.ThrowsException<ArgumentException>(() =>
            {
                PC_GAME_AUTO_TOOL.Functions.Macro.Logic.InterFace.Logic command = new GreaterThanOrEqual("1", "b");
            });
        }
    }
}
